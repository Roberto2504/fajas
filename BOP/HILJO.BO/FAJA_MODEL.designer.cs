...
namespace BOP.BO
{
    ...
    partial void OnProDet_StatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_Size_Product_Detail", Storage="_Product_Size", ThisKey="ProDet_FK_ProSiz", OtherKey="Siz_Pk", IsForeignKey=true)]
		public Product_Size Product_Size
		{
			...
			set
			{
							...
							|| (this._Product_Size.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.Product_Detail.Add(this);
						this._ProDet_FK_ProSiz = value.Siz_Pk;
					}
					else
					{
						this._ProDet_FK_ProSiz = default(int);
					}
    ...
    partial void OnSiz_PkChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_Size_Product_Detail", Storage="_Product_Detail", ThisKey="Siz_Pk", OtherKey="ProDet_FK_ProSiz")]
		public EntitySet<Product_Detail> Product_Detail
		{
			get
			{
